...
- **Authoritative example graph** — author a dedicated graph YAML that covers all config features and can serve as the canonical reference. Currently `graphs/test.yaml` is used as a stand-in. (`docs/harness_configs/graph.md`)
